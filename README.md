<h1 align="center">Hey There 👋, I'm Allen Jen Joseph</h1>
  <h3 align="center"> AI Automation @ Dream & First Class MEng Computer Science & Software Engineering @ University of Birmingham · Founder @ Clipify Media</h3>
  ...
  - 🔭 **Dream Content & Revenue Dashboards** — automated analytics for [Simon Squibb](https://simonsquibb.com)'s group of channels. Next.js + Supabase Postgres on Vercel, ingesting **21 accounts across 8 platforms** (Instagram, YouTube, TikTok, Threads, Facebook, LinkedIn, X, Snapchat) straight from the owner APIs — ~30M followers and ~400M views a month, replacing a manual weekly spreadsheet and saving ~4 hours a week.
  ...
  | --- | --- | --- |
  | **Etihad Airways Engineering** | Digital Technology & Innovation Intern | Delivered an enterprise IT migration for 2,400+ employees; modelled workforce scenarios projecting $24M+ in efficiency gains; technical lead in RFPs on solutions cutting opex 35% |
  | **Uptrail** | Data & Business Analyst Intern | Market analysis of Netflix's 90M+ European subscriber base; built the business case for the ad-supported tier (20%+ potential new sign-ups) |
  | **Bizgees** *(Winner — INFOSYS Challenge)* | Software & AI Game Development Intern | Led a team of 4 building 6 AI games around refugee stories; wrote the developer manual that halved onboarding time |
  | **Clipify Media** | Founder | Bootstrapped the agency, built the team, ran strategy → scheduling → analytics end to end |

  🎓 **MEng Computer Science & Software Engineering**, University of Birmingham (2022–2026) · 1:1 Honours (expected) · The Birmingham Award · Chancellor's Academic Merit Scholarship
  ...
  Software Engineering · Data & Analytics Engineering · Applied AI / LLM Pipelines · Human-Computer Interaction · Software Design

  ### 📫 Reach me

  **allenjjoseph03@gmail.com** — happy to talk about analytics platforms, AI pipelines, or building content systems that scale.
  ...
  <a href="https://www.postgresql.org/docs/current/sql.html" target="_blank" rel="noreferrer"> <img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/azuresqldatabase/azuresqldatabase-original.svg" alt="sql" width="40" height="40"/> </a>
...
<p align="center">🌐 Connect with me to share ideas, collaborate on projects, or just geek out about the latest tech trends. Happy coding! 🌈</p>
